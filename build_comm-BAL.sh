...
:${PPWW:=`pwd`}
:${Record_File_name:=Build-BAL-3.2.2.2-logs.txt}
...
: ${BALSRC_ZIPNAME:=SW-BCM686OLT_3_2_2_2.tgz}
: ${SDK_VERSION:=6.5.13}
: ${PATCH_FILENAME:=ACCTON_BAL_3.2.2.2-V201911080101.patch}
: ${PATCH_FILENAME_LATEST:=ACCTON_BAL_3.2.2.2-V201911080101.patch}
